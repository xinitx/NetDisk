...
public class MyMvcConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/aliyun/avatar/**").addResourceLocations("file:D:\\aliyunfile\\avatar\\");
        registry.addResourceHandler("/aliyun/file/**").addResourceLocations("file:D:\\aliyunfile\\files\\");
    }
